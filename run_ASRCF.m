...
params.search_area_shape = 'square';    % the shape of the training/detection window: 'proportional54', 'square' or 'fix_padding'
...
params.rho_size = 10; %预定学习速率的攀升长度
params.ita = 0.2;%预定学习速率的攀升速率，ita越大攀升越快
